...
const CPU_SPECS = [
  ...
  },
  {
    ...
    specs:[
      ...
      { label: 'Score', key: 'score' }, // Ajouté pour la cohérence
    ]
  },
  {
    group: 'Analyse',
...
const GPU_SPECS = [ /* ... tes specs GPU ... */ ];
const LAPTOP_SPECS = [ /* ... tes specs Laptop ... */ ];
const TELEPHONE_SPECS = [ /* ... tes specs Telephone ... */ ];
